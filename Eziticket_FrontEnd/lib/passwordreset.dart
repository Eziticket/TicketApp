    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          Padding(
            padding: const EdgeInsets.only(left: 20, right: 15, bottom: 20,top: 30),
            child: SizedBox(
              height: 45,
           ...
           Padding(
            padding: const EdgeInsets.only(left: 20, right: 15, bottom: 50,top: 30),
             child: SizedBox(
               height: 45,
                width: MediaQuery.of(context).size.width,
                child: Padding(
            ...
            child: Padding(
              ...
              child: Container(
                    ...
                    children: [const Padding(
                      ...
                      child: Center(
                        child: Text("DON'T HAVE AN ACCOUNT?", style:
                            TextStyle(color: CupertinoColors.systemGrey3, fontSize: 18),
                  ...
                  Padding(
                    ...
                    child: TextButton(onPressed: (() =>Navigator.of(context).push(MaterialPageRoute(builder: (context)=> const RegisterScreen()))),
