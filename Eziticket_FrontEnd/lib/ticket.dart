...
class _ticketState extends State<ticket> {
  ...
  builddetail4() => (ListTile(
      ...
      subtitle:
          const Align(alignment: Alignment.bottomLeft, child: Text('12 Jan 2022')),
      trailing: Container(
          decoration: (const BoxDecoration(
  ...
  builddetail6() => (ListTile(
        title: const Text('ID:'),
        subtitle:
            const Align(alignment: Alignment.bottomLeft, child: Text('4489-92-XXX')),
        trailing: Padding(
            padding: const EdgeInsets.only(right: 50),
            child: Container(
              decoration: (const BoxDecoration(
  ...
  builddetails8() => Column(
        children: [
          ...
          const Align(alignment: Alignment.center, child: Text('2463759468204776E0')),
        ],
      );
  // builddetails8() => (ListTile(
  //       leading: Padding(
